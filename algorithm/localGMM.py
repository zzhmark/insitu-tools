...
def local_gmm(image, global_label,
              levels, n=10, label_only=True):
    ...
    image = None if label_only else \
        img_as_ubyte(
            label2rgb(local_label, image, bg_label=0)
        )
